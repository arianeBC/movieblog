...
export default class ReviewSeeder extends BaseSeeder {
  public async run () {
    await Review.createMany([
      ...
      {
        rank: 6,
        title: 'Most interesting "food for thought" narrative compromised by lack of judicious editing',
        comment: '"Force Majeure" falls under the appellation of the "interesting" film. There\'s much food for thought here as one attempts to decipher the film\'s underlying meaning. The film\'s weakness is the lack of judicious editing, causing it to often move along at a glacial pace. I could have done without some of the long-winded visuals as their presence was detrimental to the narrative\'s overall fluidity.',
        userId: 3,
        movieId: 2
      },
      {
      ...
      },
      {
        ...
        comment: 'Overall I found this quite a deep, thoughtful and very German movie. Watch lots of German movies and you will know what I mean. I would be very hesitant to watch it twice.',
        userId: 4,
        movieId: 3
      },
      {
        ...
        comment: 'But it\'s well done and I like that it\'s dialogue was mostly unscripted and most of the actors are real people taken from the streets. It felt like a real dysfunctional road trip with some interesting characters. Pretty raw at times.',
        userId: 3,
        movieId: 4
      },
      {
      ...
      },
      {
        ...
        comment: 'Happy-Go-Lucky is a highly enjoyable and often very funny film, but it also carries terrible sadness. I have never been a massive fan of Mike Leigh, but lately I have to admit that I was wrong. He just seems to get better and better.',
        userId: 2,
        movieId: 5
      },
      {
        rank: 8,
        title: 'A cheerful film with an underlying vein of tragedy',
        comment: 'The director has done a superb job with this production; it is packed with intelligent, witty dialogs and convincingly drawn characters. Our world needs a lot more people like Poppy, or at least -- if they don\'t possess her strength and optimism -- people who are sympathetic with her values instead of feeling threatened by humaneness. Yes, life is difficult and often sad, so let\'s tackle it with a smile!',
        userId: 4,
        movieId: 5
      },
    ])
